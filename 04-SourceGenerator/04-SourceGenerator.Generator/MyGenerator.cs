using _04_SourceGenerator.Attributes;
using _04_SourceGenerator.Generator.Helpers;
...
namespace _04_SourceGenerator.Generator;
        ...
        foreach (ClassDeclarationSyntax candidateClass in receiver.CandidateClasses)
        {
            ...
            foreach (var attribute in classSymbol.GetAttributes())
            {
                if (attribute.AttributeClass.Name == attributeSymbol.Name)
                {
                    ...
                    {
                        string json = File.ReadAllText(swaggerDescriptorPath);
